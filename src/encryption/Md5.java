...
public class Md5 {
    ...
    private String getStringFormBytes(byte[] bytes) {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        Md5 md5 = new Md5();
        System.out.println(md5.getMd5("ll"));

        MessageDigest messageDigest = MessageDigest.getInstance("Md5");
        System.out.println(md5.getStringFormBytes(messageDigest.digest("ll".getBytes())));
    }
